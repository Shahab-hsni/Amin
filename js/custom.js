(function () {
    ...
    TweenMax.from('.moon1', {
        y: 200, opacity: 0, ease: Back.easeOut.config(1.7), duration: 2, onComplete: () => {
            setTimeout(() => {
                $('.satelite').attr({ "data-scroll": '', "data-scroll-speed": '3', 'data-scroll-position': 'top' })
                $('.jupiter').attr({ "data-scroll": '', "data-scroll-speed": '-2', 'data-scroll-position': 'top' })
                scroll.update()
            }, 500)
        }
    });
    ...
    scroll.on('scroll', (e) => {
        if (e.scroll.y > 0) {
            document.querySelector(".mobile-view").style.transform = "translate(0px, 0px)";
            document.querySelector(".mobile-view").style.transform += 'scale(1)';
            ...
            document.querySelector(".mobile-view").style.transform = "translate(10vw, 18vh)";
            document.querySelector(".mobile-view").style.transform += 'scale(4, 4.5)';
